...
import static org.apache.sqoop.mapreduce.ParquetJob.INCOMPATIBLE_AVRO_SCHEMA_MSG;
        ...
        if (numRecords == 0) {
          ...
          if (Datasets.exists(uri)) {
            ...
            if (!SchemaValidationUtil.canRead(writtenWith, schema)) {
              throw new AvroSchemaMismatchException(INCOMPATIBLE_AVRO_SCHEMA_MSG, writtenWith, schema);
            }
            if (dataset.isEmpty()) {
